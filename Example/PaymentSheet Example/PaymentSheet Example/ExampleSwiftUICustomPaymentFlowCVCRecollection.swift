...
class MyCustomBackendCVCRecollectionModel: ObservableObject {
    ...
    func confirmIntent(paymentMethodID: String,
        ...
        let body: [String: Any?] = [
            ...
            "require_cvc_recollection": self.isCVCRecollectionEnabled(),
        ]
    ...
    func intentConfiguration() -> PaymentSheet.IntentConfiguration {
        return PaymentSheet.IntentConfiguration(mode: .payment(amount: 100, currency: "usd", setupFutureUsage: .offSession, captureMethod: .automatic, isCVCRecollectionEnabled: isCVCRecollectionEnabled()),
